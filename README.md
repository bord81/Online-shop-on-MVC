This repository contains an example of backend for a simple online shop using Spring MVC and Thymeleaf. The project has a main page, catalogue, cart and contact sections.
